...
## Local stack (4 CPU / 8 GB)

Sized ClickHouse + HyperDX for a laptop:
...
Creds: `default` / `asdfzxcv` (see `.env`). HyperDX source + chart setup: [docs/HYPERDX_INMOBI.md](docs/HYPERDX_INMOBI.md).
